    ...
    ContentSection {
        ...
        ConfigRow {
            ...
            MaterialTextArea {
                ...
                text: Config.options.bar.sports.sport
                onTextChanged: Config.options.bar.sports.sport = text
            }
            MaterialTextArea {
                Layout.fillWidth: true
                placeholderText: Translation.tr("League (e.g. eng.1, all)")
                text: Config.options.bar.sports.league
                onTextChanged: Config.options.bar.sports.league = text
            }
        }
        ...
        ConfigRow {
            ...
            MaterialTextArea {
                Layout.fillWidth: true
                placeholderText: Translation.tr("Team filter (Optional)")
